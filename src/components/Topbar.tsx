...
export function Topbar({ selNode, selIdx, visibleCount, stats }: TopbarProps) {
  return (
    <div style={{ backgroundColor: C.bgAlt, borderBottom: `1px solid ${C.border}`,
      flexShrink: 0, fontSize: '13px', display: 'flex', alignItems: 'center',
      padding: '5px 16px', gap: '0' }}>
      {/* Buffer label */}
      <span style={{ backgroundColor: C.blue, color: C.bgAlt, padding: '0 6px', borderRadius: '2px', flexShrink: 0 }}>Org</span>
